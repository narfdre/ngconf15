angular.module('turbo', ['d3', 'dchart.scatter']).directive('d3Bars', ['$window', '$timeout', 'd3Service',
                ...
                d3Service.d3().then(function(d3) {
                    ...
                    scope.render = function(data) {
                        ...
                        renderTimeout = $timeout(function() {
                            ...
                            svg.selectAll('text').data(data).enter().append('text').attr('fill', '#000').attr('y', function(d, i) {
    ...
    $scope.greeting = "Highest Opening Weekend";
    $scope.data = [{
        name: "Movie One",
        score: 10000000
    }, {
    ...
    console.log($scope.scatterDataSet1);
    ...
    $scope.scatterDataSet1 = $scope.movies;
